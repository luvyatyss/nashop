...
$numberOfRows = $filterODetail->countRecords();// Số lượng dòng của bảng
$ListODetails= array();
    ...
    <table class="table table-bordered">
        ...
        foreach ($ListODetails as $ItemOD) {
            ...
            <tr>
                ...
                <td style="width: 200px;"><?php echo $ItemOD->getOrderDetailID(); ?></td>
                <td style="width: 200px;"><?php echo $ItemOD->getProduct()->getProName(); ?></td>
                <td style="width: 200px;" class="text-right"><?php echo number_format($ItemOD->getQuantity(),0); ?></td>
                <td style="width: 200px;" class="text-right"><?php echo number_format($ItemOD->getPrice(),0); ?></td>
                <td style="width: 200px;" class="text-right"><?php echo number_format($ItemOD->getAmount(),0); ?></td>
            </tr>
        <?php }
        ?>
        </tbody>
